        ...
        <tbody>
            ...
            while ($ver = mysqli_fetch_row($result)) {
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-simple btn btn-success btn-icon" data-toggle="modal" data-target="#modalEdicion" onclick="AgregarFrmEmpleado('<?php echo $datos ?>')">
                            <i class="material-icons">edit</i>
                        </a>

                        <a class="btn btn-simple btn btn-danger btn-icon" onclick="preguntarSiNoEmpleado('<?php echo $ver[0] ?>')">
