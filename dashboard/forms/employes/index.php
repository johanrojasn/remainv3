                    ...
                    <div class="card">
                        <form id="RegisterValidation" action="#" method="">
                            ...
                            <div class="card-content">
                                ...
                                <input type="hidden" name="" id="idEmpleado" class="form-control input-sm">
                                <div class="card-content">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <select id="Cargo2" class="form-control" required="">
                                                <option value="0">---Seleccionar----</option>
                                                <?php
                                                $sql = "select * from Cargo;";
                                                $result = mysqli_query($conexion, $sql);
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#guardarnuevo').click(function () {
            ...
            Correo = $('#Correo').val();
            Cargo = $('#Cargo').val();
            AgregarEmpleado(Nombres, Apellidos, Dni, Celular, Telefono, Correo, Cargo);
        });
