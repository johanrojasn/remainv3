...
$sql = "SELECT * FROM `detalleserviciocopia` WHERE detalleserviciocopia=$id";
...
//$fpdf->Image('img/2.png', 90, 0, 30);
    ...
    if ($ver[14] == "Registro") {
        ...
        $fpdf->SetX(5);
        $fpdf->SetFont('Courier', '', 5);
        $fpdf->Cell(20, 2, 'Codigo Servicio   : ' . $ver[2]);

        $fpdf->Ln(2);
        $fpdf->SetX(5);
        $fpdf->Cell(20, 2, 'Ocurrencia        : ' . $ver[3]);

        $fpdf->Ln(2);
        $fpdf->SetX(5);
        $fpdf->Cell(20, 2, 'Status            : ' . $ver[4]);

        $fpdf->Ln(2);
        $fpdf->SetX(5);
        $fpdf->Cell(20, 2, 'Urgencia          : ' . $ver[5]);

        $fpdf->Ln(2);
        $fpdf->SetX(5);
        $fpdf->Cell(20, 2, 'Asistencia        : ' . $ver[6]);
...
//////////////////////////////////////////
        ...
        $fpdf->SetX(5);
        if ($ver[7] == $ver[2]) {
             $fpdf->Cell(20, 2, 'Codigo Servicio   : ' . "Sin Cambio");
        }else{
             $fpdf->Cell(20, 2, 'Codigo Servicio   : ' . 'Se Cambio ' . $ver[7] . " Por " . $ver[2]);
        }
...
//////////////////////////////////////////////////
        ...
        $fpdf->SetX(5);
           if ($ver[8] == $ver[3]) {
                $fpdf->Cell(20, 2, 'Ocurrencia        : ' . "Sin Cambio");
           }else{
               $fpdf->Cell(20, 2, 'Ocurrencia         : ' . 'Se Cambio ' . $ver[8] . " Por " . $ver[3]);
           }
...
/////////////////////////////////////////////////////
        ...
        $fpdf->SetX(5);
        if ($ver[9] == $ver[4]) {
            $fpdf->Cell(20, 2, 'Status            : ' . "Sin Cambio");
        }else{
             $fpdf->Cell(20, 2, 'Status           : ' . 'Se Cambio ' . $ver[9] . " Por " . $ver[4]);
        }
/////////////////////////////////////////////////////
        $fpdf->Ln(2);
        $fpdf->SetX(5);
         if ($ver[10] == $ver[5]) {
              $fpdf->Cell(20, 2, 'Urgencia         : ' . "Sin Cambio");
         }else{
             $fpdf->Cell(20, 2, 'Urgencia          : ' . 'Se Cambio ' . $ver[10] . " Por " . $ver[5]);
         }
...
/////////////////////////////////////////////////////
        ...
        $fpdf->SetX(5);
        if ($ver[11] == $ver[6]) {
            $fpdf->Cell(20, 2, 'Asistencia        : ' . "Sin Cambio");
        } else {
            $fpdf->Cell(20, 2, 'Asistencia        : ' . 'Se Cambio ' . $ver[11] . " Por " . $ver[6]);
            $fpdf->Ln(2);
        }
        ...
        $fpdf->SetX(5);
        $fpdf->SetFont('Courier', 'B', 5);
        $fpdf->Cell(20, 2, 'Codigo Servicio   : ' . $ver[1]);
        ...
        $fpdf->Ln(2);
        $fpdf->SetX(5);
        $fpdf->Cell(20, 2, 'Ocurrencia        : ' . $ver[8]);

        $fpdf->Ln(2);
        $fpdf->SetX(5);
        $fpdf->Cell(20, 2, 'Status            : ' . $ver[9]);

        $fpdf->Ln(2);
        $fpdf->SetX(5);
        $fpdf->Cell(20, 2, 'Urgencia          : ' . $ver[10]);

        $fpdf->Ln(2);
        $fpdf->SetX(5);
        $fpdf->Cell(20, 2, 'Asistencia        : ' . $ver[11]);
