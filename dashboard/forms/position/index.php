                        ...
                        <form id="RegisterValidation" action="#" method="">
                            ...
                            <div class="card-content">
                                ...
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" name="text" id="Cargo" type="text" required="true" />
                                </div>
                    ...
                    <div class="card">
                        <form id="RegisterValidation" action="#" method="">
                            ...
                            <div class="card-content">
                                ...
                                <input type="hidden" id="idCargo" class="form-control input-sm">
                                 <div class="form-group row">
                                    <label class="col-form-label col-md-3 col-sm-3 col-xs-3">Cargo*</label>
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="text" name="" id="Cargo2" class="form-control">                     
                                    </div>
                                </div>                      
                                <div class="form-footer text-right">
