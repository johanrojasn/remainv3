                        ...
                        <form id="RegisterValidation" action="#" method="">
                            ...
                            <div class="card-content">
                                ...
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" name="text" id="Razon" type="text" required="true" />
                                </div>
                                <div class="form-group label-floating">
                                    <label class="control-label">
                                        Ruc
                                    ...
                                    <input class="form-control" name="text" id="Ruc" type="text" required="true" />
                                </div>
                                ...
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" name="text" id="Celular" type="text" required="true" />
                                </div>
                                <div class="form-group label-floating">
                                    <label class="control-label">
                                        Correo
                                    ...
                                    <input class="form-control" name="text" id="Correo" type="text" required="true" />
                                </div>
                                <div class="form-group label-floating">
                                    <label class="control-label">
                                        Direccion
                                    ...
                                    <input class="form-control" name="text" id="Direccion" type="text" required="true" />
                                </div>
                    ...
                    <div class="card">
                        <form id="RegisterValidation" action="#" method="">
                            ...
                            <div class="card-content">
                                ...
                                <input type="hidden" name="" id="idCliente" class="form-control input-sm">
                                <div class="card-content">
                                    <div class="row">
                                        <label class="col-sm-2 label-on-left">Razon Social</label>
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input id="Razon2" type="text" class="form-control" value>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input id="Ruc2" type="text" class="form-control" value>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input id="Celular2" type="text" class="form-control" value>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-sm-2 label-on-left">Correo</label>
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input id="Correo2" type="text" class="form-control" value>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input id="Direccion2" type="text" class="form-control" value>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#guardarnuevo').click(function () {
                ...
                AgregarCliente(Razon, Ruc, Celular, Correo, Direccion);
            });
            ...
            $('#guardarnuevos').click(function () {
                ...
                Correo = $('#Correo').val();
                Cliente = $('#Cliente').val();
                AgregarEmpleadoCliente(Nombres, Apellidos, Dni, Celular, Telefono, Correo, Cliente);
            });
            $('#actualizadatos2').click(function () {
                ActualizarEmpleadoCliente();
            });
