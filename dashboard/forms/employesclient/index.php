                        ...
                        <form id="RegisterValidation" action="#" method="">
                            ...
                            <div class="card-content">
                                ...
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" name="text" id="Telefono" type="text" required="true" />
                                </div>
                                <div class="form-group label-floating">
                                    <label class="control-label">
                                        Correo
                    ...
                    <div class="card">
                        <form id="RegisterValidation" action="#" method="">
                            ...
                            <div class="card-content">
                                ...
                                <input type="text" name="" id="idEmpleado" class="form-control input-sm">
                                <div class="card-content">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <input id="Telefono2" type="text" class="form-control" value>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <select id="Cliente2" class="form-control" required="">
                                                <option value="0">---Seleccionar----</option>
                                                <?php
                                                $conexion = conexion();
                                                $sql = "select * from Clientes;";
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label"></label>
                                                <select id="Perfil2" class="form-control" required="">
                                                <option value="0">---Seleccionar----</option>
                                                <?php
                                                $conexion = conexion();
                                                $sql = "SELECT * FROM `cargocliente`";
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#guardarnuevo').click(function () {
                ...
                Cliente = $('#Cliente').val();
                Perfil = $('#Perfil').val();
                AgregarEmpleadoCliente(Nombres, Apellidos, Dni, Celular, Telefono, Correo, Cliente, Perfil);
            });
