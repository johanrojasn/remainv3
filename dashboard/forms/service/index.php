                        ...
                        <form id="RegisterValidation" action="#" method="">
                            ...
                            <div class="card-content">
                                ...
                                <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 col-xs-3">Cliente*</label>
                                        <div class="col-sm-10">
                                            <select id="Cliente" class="form-control" required="">
                                                <option value="0">---Seleccionar----</option>
                                                <?php
                                                $sql = "select * from clientes_empleados;";
                                ...
                                <div class="form-group label-floating">  
                                    <input class="form-control" name="text" id="Fecha" type="date" required="true" />
                                </div>
                                 <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 col-xs-3">Tecnicos*</label>
                                        <div class="col-sm-10">
                                            <select id="idTecnico" class="form-control" required="">
                                                <option value="0">---Seleccionar----</option>
                                                <?php
                                                $sql = "select * from Empleado where idcargo=14;";
                                                $result = mysqli_query($conexion, $sql);
                                                while ($ver = mysqli_fetch_row($result)) {
                    ...
                    <div class="card">                      
                        <form id="RegisterValidation" action="#" method="">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-content">
                                    <input type="hidden" name="" id="idServicio" class="form-control"> 
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 col-xs-3">Empresa*</label>
                                        <div class="col-sm-10">
                                            <input type="text" readonly="" name="" id="2" class="form-control input-sm">
                                        </div>
                                    </div>
                                <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 col-xs-3">Cliente*</label>
                                        <div class="col-sm-10">
                                            <select id="Clientes2" class="form-control" required="">
                                                <option value="0">---Seleccionar----</option>
                                                <?php
                                                $sql = "select * from clientes_empleados;";
                                                $result = mysqli_query($conexion, $sql);
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 col-xs-3">Fecha*</label>
                                        <div class="col-md-9 col-sm-9 col-xs-9">
                                            <input type="date" name="" id="Fecha2" class="form-control">                     
                                        </div>
                                    </div> 
                                    
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 col-xs-3">Tecnico*</label>
                                        <div class="col-sm-10">
                                            <select id="idTecnico2" class="form-control" required="">
                                                <option value="0">---Seleccionar----</option>
                                                <?php
                                                $sql = "select * from Empleado where idcargo=14";
                                                $result = mysqli_query($conexion, $sql);
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#guardarnuevo').click(function () {
                ...
                AgregarServicio(Cliente, Fecha,idTecnico);
            });
